    ...
    */
        ...
        public string TPO_SalesVoucherCollectionXMLRequest(string CURRENTCOMPANY, string BOOKBEGINNINGFROM, string LASTVOUCHERENTRYDATE, string LASTVOUCHERID, string CURRENTLASTVOUCHERID, string COMPANYINITIALS)
        {
            ...
            try
            {
                ...
                xmlstc = xmlstc + "<Compute>CGSTAmt   : if $$IsEmpty:$$FilterAmtTotal:LedgerEntries:IsCGSTLedger:$Amount then '0' else  $$FilterAmtTotal:LedgerEntries:IsCGSTLedger:$Amount</Compute>\r\n";
                xmlstc = xmlstc + "<Compute>RNDOFFAmt   : if $$IsEmpty:$$FilterAmtTotal:LedgerEntries:IsRoundOffLedger:$Amount then '0' else  $$FilterAmtTotal:LedgerEntries:IsRoundOffLedger:$Amount</Compute>\r\n";
                ...
                xmlstc = xmlstc + "<Compute>PONumber  :  if $$IsEmpty:$$CollectionField:$BasicPurchaseOrderNo:1:InvoiceOrderList then 'NA' else $$CollectionField:$BasicPurchaseOrderNo:1:InvoiceOrderList</Compute>\r\n";
                xmlstc = xmlstc + "<Compute>PODate  :  if $$IsEmpty:$$CollectionField:$BasicOrderDate:1:InvoiceOrderList then 'null' else $$CollectionField:$BasicOrderDate:1:InvoiceOrderList</Compute>\r\n";
                ...
                xmlstc = xmlstc + "<SYSTEM TYPE =  'Formulae'  Name = 'IsRoundOffLedger'>$VATDealerNature:Ledger:$LedgerName = 'Invoice Rounding'</SYSTEM>\r\n";
                xmlstc = xmlstc + "</TDLMESSAGE>\r\n";
                xmlstc = xmlstc + "</TDL>\r\n";
                xmlstc = xmlstc + "</DESC>\r\n";
                xmlstc = xmlstc + "</BODY>\r\n";
