    ...
    public class APIConnection
    {
        ...
        public string SignUpOnTrackpayoutWebServer(string pWebReqstStr)
        {
            ...
            try
            {
                ...
                String lClearBalanceHost = "http://trackpayout.contisofttechno.com:8001/api/tally/utility/company/register_company";
                HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(lClearBalanceHost);
                httpWebRequest.Method = "POST";
                httpWebRequest.Timeout = 600000;
                httpWebRequest.ContentLength = (long)pWebReqstStr.Length;
        ...
        public string SetLastDetailOnTrackpayoutWebServer(string pWebReqstStr)
        {
            ...
            try
            {
                ...
                String lClearBalanceHost = "http://trackpayout.contisofttechno.com:8001/api/tally/utility/company/set_last_details";
                HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(lClearBalanceHost);
                httpWebRequest.Method = "POST";
                httpWebRequest.Timeout = 600000;
                httpWebRequest.ContentLength = (long)pWebReqstStr.Length;
        ...
        public string CheckGUIDTrackPayoutWebServer(string GUID)
        {
            ...
            try
            {
                ...
                String lClearBalanceHost = "http://trackpayout.contisofttechno.com:8001/api/tally/utility/company/get_companyid_by_guid?company_gu_id=" + GUID;
                HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(lClearBalanceHost);
        ...
        public string getlastDetailTrackPayoutWebServer(string companyid)
        {
            ...
            try
            {
                ...
                string lClearBalanceHost = "http://trackpayout.contisofttechno.com:8001/api/tally/utility/company/get_last_details?company_id=" + companyid;
        ...
        public string checkcompanyValidityTrackPayoutWebServer(string companyid)
        {
            ...
            try
            {
                ...
                string lClearBalanceHost = "http://trackpayout.contisofttechno.com:8001/api/tally/utility/company/is_valid?company_id=" + companyid;
            ...
            try
            {
                ...
                JArray voucherdoc =
                     new JArray(
                           ...
                           select new JObject(
                                   ...
                                   new JProperty("po_dt", vouchers["PODate"]),
                ...
                JArray receiptvoucherDoc =
                   new JArray(
                    ...
                    //else
                    //{
                    //    this.customerPosttag = "Customer are up-to-date.";
        ...
        public string Customer_Track_payout_POST_SendReqst(string pWebReqstStr)
        {
            ...
            try
            {
                ...
                String lClearBalanceHost = "http://trackpayout.contisofttechno.com:8001/api/tally/utility/customer/store";
                HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(lClearBalanceHost);
                httpWebRequest.Method = "POST";
                httpWebRequest.Timeout = 600000;
                httpWebRequest.ContentLength = (long)pWebReqstStr.Length;
        ...
        public string Invoice_Track_payout_POST_SendReqst(string pWebReqstStr)
        {
            ...
            try
            {
                ...
                String lClearBalanceHost = "http://trackpayout.contisofttechno.com:8001/api/tally/utility/invoice/store";
                HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(lClearBalanceHost);
                httpWebRequest.Method = "POST";
                httpWebRequest.Timeout = 600000;
                httpWebRequest.ContentLength = (long)pWebReqstStr.Length;
        ...
        public string Receipt_Track_payout_POST_SendReqst(string pWebReqstStr)
        {
            ...
            try
            {
                ...
                String lClearBalanceHost = "http://trackpayout.contisofttechno.com:8001/api/tally/utility/invoice/credit_notes";
                HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create(lClearBalanceHost);
                httpWebRequest.Method = "POST";
                httpWebRequest.Timeout = 600000;
                httpWebRequest.ContentLength = (long)pWebReqstStr.Length;
